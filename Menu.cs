    ...
    class Menu
    {
        ...
        public static int ReturnKey()
        {
            ...
            do
            {
                ...
                if (char.IsDigit(menuKeyInfo.KeyChar))
                    strNumber = menuKeyInfo.KeyChar.ToString();
        ...
        public class MainMenu
        {
            ...
            public static void MainMenuWriter()
            {
                ...
                do
                {
                    ...
                    System.Console.WriteLine("2 Continue");
                    System.Console.WriteLine("3 Save game");
                ...
                static void SettingsHandler(int v)
                {
                    ...
                    /* switch (v)
                    {
                        ...
                        case (1):
                            ...
                            SourseBuilde.keyBuild = Console.ReadKey().KeyChar;
                            //MainMenuSettings();
                            break;
                        case (3):
                            System.Console.Write("Change new Key: ");
                            SourseBuilde.background = Console.ReadKey().KeyChar;
                            //MainMenuSettings();
                            break;
                        case (2):
                            Console.Clear();
                            ...
                            if (Settings.isColorScreen == 1)
                            {
                                for (int i = 0; i < Run.GameFild.FildGame.GetLength(0); i++)
                                {
                                    for (int j = 0; j < Run.GameFild.FildGame.GetLength(1); j++)
                                    {
                                        ...
                                        else Run.GameFild.FCScreen.FildColorArray[i, j] = Settings.ConsColBackground;
            ...
            class ScreenTextOptionMenu
            {
                ...
                public static void ScreenTextOption()
                {
                    ...
                    do
                    {
                        ...
                        System.Console.WriteLine($"3 Char background: {Settings.keyBackground}");
                ...
                static void ScreenTextOptionHandler(int v)
                {
                    ...
                    {
                        case (1):
                            System.Console.Write("Choise new Key: ");
                        ...
                        case (3):
                            System.Console.Write("Choise new Key: ");
                            Settings.keyBackground = Console.ReadKey().KeyChar;
                            break;
                        case (4):
                            Settings.ConsColBackground = ChooseColor();
                            break;
            ...
            class ControlOptionMenu
            {
                ...
                public static void ControlOption()
                {
                    ...
                    {
                        Console.Clear();
                        System.Console.WriteLine($"1 Left: {Settings.controlsKeys[0]}");
                        System.Console.WriteLine($"2 Right: {Settings.controlsKeys[1]}");
                        System.Console.WriteLine($"3 Down: {Settings.controlsKeys[2]}");
                        System.Console.WriteLine($"4 Rotate: {Settings.controlsKeys[3]}");
                        System.Console.WriteLine($"5 Quit: {Settings.controlsKeys[4]}");
                        System.Console.WriteLine("\n8 Back");
                ...
                static void ControlOptionHandler(int v)
                {
                    ...
                    {
                        case (1):
                            Settings.controlsKeys[0] = Console.ReadKey(true).KeyChar;
                            break;
                        case (2):
                            Settings.controlsKeys[1] = Console.ReadKey(true).KeyChar;
                            break;
                        case (3):
                            Settings.controlsKeys[2] = Console.ReadKey(true).KeyChar;
                            break;
                        case (4):
                            Settings.controlsKeys[3] = Console.ReadKey(true).KeyChar;
                            break;
                        case (5):
                            Settings.controlsKeys[4] = Console.ReadKey(true).KeyChar;
                            break;
                        case (8):
                            isEnd = false;
                            break;
